...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/sort.css" charset="utf-8">
	...
	<body>
			...
			<div class="dnav">
				...
				<!-- 菜单 -->
				  <ul class="nav-list">
				    ...
				    <li>
						<a href="sort.php" class="active">论坛分类<div class="carect"></div></a>
						<ul class="menu">
		...
		<div class="container">
			...
			<div class="sortmain">
				<li style="margin-right: 10px;"><a href="xuexi.php"><div class="kuai">学习区</div><img src="images/01.jpg" width="100%" alt="学习区" /></a></li>
				<li><a href="shenghuo.php"><div class="kuai">生活区</div><img src="images/02.jpg" width="100%" alt="生活区" /></a></li>
				<li style="margin-right: 10px; margin-top: 10px;"><a href="xinwen.php"><div class="kuai">新闻区</div><img src="images/03.jpg" width="100%" alt="新闻区" /></a></li>
				<li style="margin-top: 10px;"><a href="yundong.php"><div class="kuai">运动区</div><img src="images/04.jpg" width="100%" alt="运动区" /></a></li>
			</div>
