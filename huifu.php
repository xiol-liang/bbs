...
?>
<?php
	 	$sql="select tb_discuss.id,tb_member.id,member_id,head,name,content,createtime from tb_discuss,tb_member where tb_member.id=member_id and tb_discuss.id=".$_GET['id'];//定义查询语句
	...
	<body>
		...
		<div class="container">
			...
			<div class="postmain">
				<table width="100%" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
					<tr bgcolor="#DDEFFD" style="font-size:16px;">
						<td width="120px" height="60px" align="center" valign="middle">评论信息</td>
						<td colspan="2" align="center" valign="middle"></td>
					</tr>
					<tr bgcolor="#ffffff">
						<td width="120px" height="60px" align="center" valign="middle"><img src="<?php echo "images/".$rst1[3]; ?>"></td>
						<td width="900px" align="left" valign="middle" style="text-indent: 2em;"><?php echo $rst1[4]; ?></td>
						
						<td rowspan="2" width="180px" align="center" valign="middle"><?php echo $rst1[6]; ?></td>	
					</tr>
					<tr>
						<td height="60px"></td>
						<td align="left" valign="middle" style="text-indent: 2em; padding-bottom: 1em;"><?php echo $rst1[5]; ?></td>
					</tr>
				</table>
			</div>
			<?php
			 		$l_sqlstr = "select * from tb_reply1 where discuss_id=".$_GET['id'];//定义查询语句
					...
					$offset=($page-1)*$pagesize;			//计算下一页从第几条数据开始循环
			 		$l_sqlstr = "select discuss_id,tb_member.id,member_id,head,name,content,createtime from tb_reply1,tb_member where member_id=tb_member.id and discuss_id = '".$_GET['id']."' order by createtime asc limit $offset, $pagesize";//定义查询语句,按照评论时间降序排列
			 ?>
			 <?php
			 		$i=$offset+1;//文章序号
			 		$result = $pdo->prepare($l_sqlstr);//准备查询 
			...
			<div class="postmain">
				<table width="100%" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
					<tr bgcolor="#DDEFFD" style="font-size:16px;">
						<td width="120px" height="60px" align="center" valign="middle">评论回复</td>
						<td colspan="2" align="center" valign="middle"></td>
					</tr>
					<?php
							$result = $pdo->prepare($l_sqlstr);//准备查询 
					...
					<tr bgcolor="#ffffff">
						...
						<td width="900px" align="left" valign="middle" style="text-indent: 2em;"><?php echo $l_rst[4]; ?></td>
					...
					<tr class="">
						...
						<td align="left" valign="middle" style="text-indent: 2em;padding-bottom: 1em;border-bottom: 1px solid #000000;"><?php echo $l_rst[5]; ?></td>
					</tr>
					<?php
							$i=$i+1;
							}
			 ...
			 <?php
			 			...
			 			<table height="140px" width="100%" border="0" cellpadding="0" cellspacing="0">
			 				<tr height="56px" style="font-size:22px;"><td align="center" valign="middle" ><img src="images/评论(1).png" /><br>该评论暂无回复！快来说两句吧！！！</td></tr>
			 			</table>
			 			<?php
			 ...
			 <div class="discuss">
			 			...
			 			<form name="myform" method="post" action="check_huifu.php?id=<?php echo $_GET['id']; ?>">
			 				   ...
			 				   <div style="width: 100%;" align="center" valign="top" >
			 				    ...
			 				    <div class="discuss_" style="width: 100%;">
			 					  <div class="discuss_1">我要回复</div>
			 					  <div class="discuss_2"><textarea name="txt_content" onfocus="return txtFocus()" onblur="return txtBlur()" style="width: 100%;height: 100%; border: 1px solid  #41a1f2; border-radius: 5px;" id="txt_content" ></textarea></div>
			 				    </div>
			 				    <div class="discuss_3" align="center">
