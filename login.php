	...
	<body>
		<div class="daohang">
			...
			<div class="demo form-bg">
				<div class="container" style="background: #494A5F;">
					<div class="kuang">
						<div class="col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 " style="margin-top: 6%;">
							<form class="form-horizontal" name="loginform" id="loginform" action="login_chk.php" method="post">
								<span class="heading">用户登录</span>
								<div class="form-group">
									<input type="text" id="name" name="name" value="xll" class="form-control"placeholder="用户名">
									<i class="fa fa-user"></i>
								</div>
								<div class="form-group help">
									<input type="password"id="password" name="password" value="123" class="form-control" placeholder="密码">
								...
								<div class="form-group">
									...
									<button name="login" id="login" onclick="return chk_log();" type="submit" class="btn btn-default">立刻登录</button>
								</div>
							</form>
						</div>
					</div>
